...
Wire the buzzer to pin 8.

Wire the 7-segment segments a-g to Arduino pins 2, 3, 4, 5, 6, 7, 9 (direct wires, no resistors).

Connect the COM pin of the display to GND via a 220 ohm resistor.
